...
import { LayoutGrid, BarChart3, Users, ShieldAlert, Code2, Moon, Sun, Cpu } from 'lucide-react';
...
type PageType = 'assets' | 'users' | 'audit' | 'enterprise';
...
export default function App() {
  ...
  const getActiveConfig = () => {
    switch (activePage) {
      ...
      case 'enterprise': return gridConfigs.enterprise;
      ...
      <aside className="w-60 bg-brand-sidebar text-white flex flex-col shrink-0 font-sans z-20 motion-theme">
        ...
        <nav className="py-4 flex-1">
          ...
          <NavItem 
            icon={<Cpu size={16} />} 
            label="Enterprise" 
            onClick={() => setActivePage('enterprise')} 
            active={activePage === 'enterprise'} 
            index={2}
          />
          <NavItem 
            icon={<Users size={16} />} 
